...
\subsubsection{Shortlist 2021 A1}
...
\begin{insight}
	\begin{itemize}
		\item Sempre que for provar alguma iteração, use indução.
		\item Formularização é essencial. Pense mais em como formularizar.
	\end{itemize}
\end{insight}

\clearpage

\subsubsection{INMO 2020 P3}
...
\begin{insight}
	Obviamente era impossível provar sem uma soma modificada porque, sem alguma modificação valida,
